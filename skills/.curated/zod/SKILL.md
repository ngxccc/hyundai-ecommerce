...
| 9        | Project Integration      | HIGH        | `project-`  |
...
### 9. Project Integration (HIGH)

- `project-drizzle-zod-integration` - Separate Zod validators from Drizzle schemas to avoid circular dependencies
- `project-resolver-integration` - Ensure correct type assertions when using generic Zod types in react-hook-form
...
- [Drizzle Zod Integration](references/drizzle-zod-integration.md) - Mapping table configurations to insert, select, and update schemas
- [Zod Best Practices](references/zod-best-practices.md) - Form design, Action boundaries, and custom multi-field refinements
