...
describe("Cloudinary Service", () => {
  ...
  describe("isCloudinaryUrl", () => {
    ...
    test("rejects invalid, empty, or phishing URLs", () => {
      expect(isCloudinaryUrl("https://attacker.com/cloudinary.com")).toBe(
        false,
      );
      expect(isCloudinaryUrl("https://cloudinary.com.attacker.com")).toBe(
        false,
      );
      expect(isCloudinaryUrl("data:image/png;base64,iVBORw0KGgoAAA")).toBe(
        false,
      );
