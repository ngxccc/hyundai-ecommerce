  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "group/step flex flex-1 items-center justify-center group-data-[orientation=horizontal]/stepper-nav:flex-row group-data-[orientation=vertical]/stepper-nav:flex-col last:flex-none",
          className,
        )}
        data-state={state}
