        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <FormField
            ...
            render={({
              ...
              field: ControllerRenderProps<CreateProductInput, "specs.model">;
            }) => (
              <FormItem>
          ...
          <FormField
            ...
            render={({
              ...
              field: ControllerRenderProps<CreateProductInput, "specs.power">;
            }) => (
              <NumberWithUnitField
          ...
          <FormField
            ...
            render={({
              ...
              field: ControllerRenderProps<CreateProductInput, "specs.voltage">;
            }) => (
              <NumberWithUnitField
          ...
          <FormField
            ...
            render={({
              ...
              field: ControllerRenderProps<CreateProductInput>;
            }) => (
              <FormItem>
