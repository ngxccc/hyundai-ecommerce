      ...
      <div className="mx-auto max-w-7xl px-8">
        <div className="from-primary via-primary-container to-primary-container relative flex flex-col items-center justify-between overflow-hidden rounded-2xl bg-linear-to-r p-12 md:flex-row">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <h2 className="font-display mb-4 text-5xl leading-none font-black text-white">
              {t("promos.title")}
              <br />
              {t("promos.subtitle")}
            </h2>
            <p className="text-on-primary-container max-w-md font-sans text-lg">
              {t("promos.desc")}
            </p>
          </div>
          <div className="relative z-10 mt-8 flex flex-col items-center md:mt-0 md:items-end">
            <div className="font-display mb-4 text-8xl leading-none font-black tracking-tighter text-white opacity-20">
              {t("promos.discount")}
            </div>
            <button className="text-primary font-display hover:bg-surface-container-lowest rounded-lg bg-white px-10 py-4 text-sm font-bold tracking-widest uppercase transition-all">
              {t("promos.cta")}
            </button>
          </div>
        </div>
