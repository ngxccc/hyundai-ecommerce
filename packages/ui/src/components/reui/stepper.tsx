  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "group/step flex items-center justify-center flex-1 last:flex-none group-data-[orientation=horizontal]/stepper-nav:flex-row group-data-[orientation=vertical]/stepper-nav:flex-col",
          className,
        )}
        data-state={state}
